...
class ApiService {
  ...
  // Photo analysis
  Future<Map<String, dynamic>> analyzeFieldPhoto(int fieldId, String base64Image) async {
    final response = await http.post(
      Uri.parse('$baseUrl/fields/$fieldId/photos/analyze'),
      headers: _headers,
      body: json.encode({
  ...
  // Photo analysis with GPS coordinates
  Future<Map<String, dynamic>> analyzeFieldPhotoWithGPS(int fieldId, String base64Image, double? latitude, double? longitude) async {
    final response = await http.post(
      Uri.parse('$baseUrl/fields/$fieldId/photos/analyze'),
      headers: _headers,
      body: json.encode({
  ...
  Future<Field?> createNewField(Map<String, dynamic> fieldData) async {
    final response = await http.post(
      Uri.parse('$baseUrl/fields'),
      headers: _headers,
