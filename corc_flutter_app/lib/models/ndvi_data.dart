class NDVIData {
  ...
  // Finnish version of health status
  String get healthStatusFinnish {
    if (ndviValue >= 0.6) return 'Erinomainen';
    if (ndviValue >= 0.3) return 'Hyvä';
    if (ndviValue >= 0.1) return 'Kohtalainen';
    if (ndviValue >= 0.0) return 'Huono';
    return 'Tuntematon';
  }
